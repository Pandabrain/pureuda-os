# pureuda-os &nbsp; [![bluebuild build badge](https://github.com/pandabrain/pureuda-os/actions/workflows/build.yml/badge.svg)](https://github.com/pandabrain/pureuda-os/actions/workflows/build.yml)
